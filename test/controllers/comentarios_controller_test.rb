...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { articulo_id: @comentario.articulo_id, email: @comentario.email, mensaje: @comentario.mensaje, sitio: @comentario.sitio } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { articulo_id: @comentario.articulo_id, email: @comentario.email, mensaje: @comentario.mensaje, sitio: @comentario.sitio } }
