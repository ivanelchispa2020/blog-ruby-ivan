...
class EncuestaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encuestum" do
    assert_difference('Encuestum.count') do
      post encuesta_url, params: { encuestum: { articulo_id: @encuestum.articulo_id, bueno: @encuestum.bueno, excelente: @encuestum.excelente, poco_util: @encuestum.poco_util, regular: @encuestum.regular, util: @encuestum.util } }
    end
  ...
  test "should update encuestum" do
    patch encuestum_url(@encuestum), params: { encuestum: { articulo_id: @encuestum.articulo_id, bueno: @encuestum.bueno, excelente: @encuestum.excelente, poco_util: @encuestum.poco_util, regular: @encuestum.regular, util: @encuestum.util } }
