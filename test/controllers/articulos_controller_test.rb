...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { autor: @articulo.autor, fecha_subida: @articulo.fecha_subida, parrafo: @articulo.parrafo, parrafo_principal: @articulo.parrafo_principal, titulo: @articulo.titulo } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { autor: @articulo.autor, fecha_subida: @articulo.fecha_subida, parrafo: @articulo.parrafo, parrafo_principal: @articulo.parrafo_principal, titulo: @articulo.titulo } }
